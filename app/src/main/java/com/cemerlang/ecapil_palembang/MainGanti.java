...
public class MainGanti extends AppCompatActivity implements View.OnClickListener  {
    ...
    private EditText editTextName,ednik,ednama,edkk,edhpx,edket;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.cemerlang.ecapil_palembang.R.layout.form_ganti);
        setupToolbar();
        ...
        edhpx=(EditText)findViewById(com.cemerlang.ecapil_palembang.R.id.txthp);
        edket=(EditText)findViewById(com.cemerlang.ecapil_palembang.R.id.txtketerangan);
    ...
    public String getStringImage(Bitmap bmp){
        ...
        bmp.compress(Bitmap.CompressFormat.JPEG, 13, baos);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        Toast.makeText(MainGanti.this, s , Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        //Showing toast
                        Toast.makeText(MainGanti.this, volleyError.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                String name = ednik.getText().toString()+"-"+ednama.getText().toString()+"-"+edkk.getText().toString()+"-"+edhpx.getText().toString()+"-"+edket.getText().toString() ;
    ...
    private void showFileChooser() {
        if (pilih!="1") {
            ...
            //uploadImage();
            ps1.setText("KTP Berhasil di upload");
            pilih="0";
            buttonChoose.setText("KTP Lama");
        }
    ...
    private void showFileChooser2() {
        if (pilih!="1") {
            ...
            //uploadImage();
            ps2.setText("Foto Kartu Keluarga Terbaru Berhasil di upload");
            pilih="0";
            buttonChoose2.setText("Foto Kartu Keluarga Terbaru");
 ...
 public  String dtk(String nik, String pemohon,String kk,String hpn){
     return kembali=nik+"-"+pemohon+"-"+kk+"-"+hpn;
 }
    ...
    public void onClick(View v) {
        ...
        if(v == buttonChoose){
            ...
            if( ( edkk.getText().toString().trim().length()>0) || ednik.getText().toString().trim().length()>0   ){
                ...
                Toast.makeText(MainGanti.this, "Silahkan lengkapi data terlebih dahulu", Toast.LENGTH_LONG).show();
            }
