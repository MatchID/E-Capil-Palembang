...
public class FormHilang extends AppCompatActivity implements View.OnClickListener  {
    ...
    private String UPLOAD_URL ="http://ecapilpalembang.web.id/upd/hilang.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.cemerlang.ecapil_palembang.R.layout.hilang);
        setupToolbar();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        Toast.makeText(FormHilang.this, s, Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        //Showing toast
                        Toast.makeText(FormHilang.this, volleyError.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                //Getting Image Name
               // NIK NoKK Nama Foto Keterangan HP Status
               //Foto,NIK,Nama,NoKK,HP

                String name =ednik.getText().toString()+"-"+ednama.getText().toString()+"-"+edkk.getText().toString()+"-"+edhp.getText().toString()+"-"+namaFoto;
    ...
    private void showFileChooser() {
        if (pilih!="1") {
            ...
            pilih = "1";
            namaFoto="surat Ket hilang dari kepolisian";
        }else  if (pilih=="2") {

            //uploadImage();
            ps1.setText("Foto surat Ket hilang dari kepolisian berhasil di upload");
            pilih="0";
           // buttonChoose.setText("Foto surat Ket hilang dari ke Polisian");
        }
    ...
    public void onClick(View v) {
        ...
        try{
            if((edkk.getText().toString().trim().length()>0) || (ednik.getText().toString().trim().length()>0)) {
                ...
                Toast.makeText(FormHilang.this, "Silahkan lengkapi data terlebih dahulu", Toast.LENGTH_LONG).show();
            }
        }
